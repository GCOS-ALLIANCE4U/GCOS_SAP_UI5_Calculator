		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP UI5 APP Calculator",
									"targetURL": "#gcosui5calculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gcosui5calculator-display": {
								"semanticObject": "gcosui5calculator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gcosui5calculator",
									"url": sap.ui.require.toUrl("gcosui5calculator")
								}
							}
						}
					}
